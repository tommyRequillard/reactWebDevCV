  ...
  return (
    <div className="p-4">
      <div className="flex items-center">
        ...
        <h2 className="text-xl font-semibold leading-7 mb-5 ml-3">Formations</h2>
      </div>
      <div className="flex-grow pb-5">
        <ul className="flex flex-col">
          ...
          <li className="flex justify-start items-center  mb-2 ">
            <h3 className="text-lg font-semibold leading-7 mr-2 w-8 text-cvbluetitle">2022</h3>
            <p className="ml-2">- Developpeur intégrateur d’application web - 3wa</p>
          </li>
          <li className="flex justify-start items-start  mb-2 ">
            <h3 className="text-lg font-semibold leading-7 mr-2 w-8 text-cvbluetitle">2017</h3>
            <p className="ml-2">- Certificat de compétence 5 jours pour entreprendre - CCI Vendée</p>

          </li>
          <li className="flex justify-start items-center  mb-2 ">
            <h3 className="text-lg font-semibold leading-7 mr-2 w-8 text-cvbluetitle">2013</h3>
            <p className="ml-2">- Initiateur Fédéral de Football Américain- FFFA</p>
          </li>
          <li className="flex justify-start items-center mb-2 ">
            <h3 className="text-lg font-semibold leading-7 mr-2 w-8 text-cvbluetitle">2004</h3>
            <p className="ml-2">- Formation AXA</p>
          </li>
          <li className="flex justify-start items-center  mb-2 ">
            <h3 className="text-lg font-semibold leading-7 mr-2 w-8 text-cvbluetitle">2003</h3>
            <p className="ml-2">- Formation de Web designer - ADECOPY</p>
          </li>
          <li className="flex justify-start items-start  mb-2 ">
            <h3 className="text-lg font-semibold leading-7 mr-2 w-8 text-cvbluetitle">1997</h3>
          ...
          <li className="flex justify-start items-start  mb-2 ">
            <h3 className="text-lg font-semibold leading-7 mr-2 w-8 text-cvbluetitle">1996</h3>
          ...
          <li className="flex justify-start items-start  mb-2 ">
            <h3 className="text-lg font-semibold leading-7 mr-2 w-8 text-cvbluetitle">1995</h3>
