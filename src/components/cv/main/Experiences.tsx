        ...
        <ul className="py-4">
          <li className="py-4">
            ...
            <h3 className="text-lg font-semibold leading-6 text-gray-600">Directeur général - SAS
                            MYDRYM
                            MYGARDEN</h3>
            <p className="mx-auto mt-1 text-lg mb-3 text-gray-800">Création ex-nihilo - dépôt
          ...
          <li className="py-4">
            ...
            <p className="mx-auto mt-1 text-lg mb-3 text-gray-800">
          ...
          <li className="py-4">
            ...
            <p className="mx-auto mt-1 text-lg text-gray-800">
