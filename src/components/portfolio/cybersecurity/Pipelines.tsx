...
const Pipelines = () => {
    ...
    <div className="flex justify-around items-center gap-4">
        <Link to="https://github.com/tommyRequillard/reactWebDevCV/actions/runs/11523912061">
            <div className="bg-gray-300 rounded-3xl shadow-2xl max-w-[400px] pulse-custom">
                <div className="p-2">
        ...
        <Link to="https://gitlab.com/tommyRequillard/reactWebDevCV/-/pipelines/1512934469">
            <div className="bg-gray-300 rounded-3xl shadow-2xl  max-w-[400px] pulse-custom">
                <div className="p-2">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 48">
