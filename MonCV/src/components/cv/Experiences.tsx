        ...
        <ul>
          <li>
            <h4 className="text-lg font-bold tracking-tight text-gray-900 ">2017 à JUIN
                            2023 </h4>
            <h3 className="text-sm font-semibold leading-6 text-gray-600">Directeur général - SAS MYDRYM
                            MYGARDEN</h3>
            <p className="mx-auto mt-1 max-w-xl text-sm mb-3 text-gray-800">Création ex-nihilo - depot
          ...
          <li>
            ...
            <h3 className="text-sm font-semibold leading-6 text-gray-600">Technicien hotline -
                            PCPARTNERS</h3>
            <p className="mx-auto mt-1 max-w-xl text-sm mb-3 text-gray-800">Prévention curative et veille
                            des
          ...
          <li>
            ...
            <h3 className="text-sm font-semibold leading-6 text-gray-600">Webmaster & community manager -
                            SARL Hugo Timeo</h3>
            <p className="mx-auto mt-1 max-w-xl text-sm mb-3 text-gray-800">Création de site web,
          ...
          <li>
            ...
            <h3 className="text-sm font-semibold leading-6 text-gray-600">Chargé de developpement associatif
                            - HUSSARDS Yonnais</h3>
            <p className="mx-auto mt-1 max-w-xl text-sm mb-3 text-gray-800"> Responsable administratif,
                            conseil
          ...
          <li>
            ...
            <h3 className="text-sm font-semibold leading-6 text-gray-600">Chargé de developpement -
                            Isol’ouate </h3>
            <p className="mx-auto mt-1 max-w-xl text-sm text-gray-800">Responsable commerciale sur toute la
          ...
          <li>
            ...
            <h3 className="text-sm font-semibold leading-6 text-gray-600">Agent logistique - PRB</h3>
            <p className="mx-auto mt-1 max-w-xl text-sm text-gray-800">Saisie commandes clientèle,
