...
const CardsLibrairies = () => {
  return (
    <>
      <div className="flex mx-2 items-center mt-2 mb-5 border-t border-darker">
      ...
      <div className="flex w-full flex-col items-centermb-2">
        <div className="flex w-full mx-auto">
          <ul className="flex flex-row flex-wrap justify-around items-end">
            {data.libraries.map((libraries) => (
              <li key={libraries.id} className="flex flex-col justify-center item-center mb-3">
                <div className="flex justify-center">
                  <img src={libraries.logoPath} alt={libraries.name} className="w-10"/>
                </div>
                <div className="flex justify-center flex-col items-center"> {libraries.name}
